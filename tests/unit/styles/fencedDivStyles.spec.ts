...
describe('fenced div live-preview styles', () => {
    ...
    it('uses a contained callout treatment instead of a bare vertical rule', () => {
        ...
        expect(styles).toMatch(/\.cm-pem-fenced-div-line:not\(\.HyperMD-list-line\)\s*\{[^}]*padding-inline-start:\s*var\(--pem-fenced-div-content-indent\)\s*!important/s);
    ...
    it('indents nested fenced div containers', () => {
        ...
        expect(styles).toMatch(/\.cm-pem-fenced-div-inner:not\(\.HyperMD-list-line\)\s*\{[^}]*padding-inline-start:\s*calc\(var\(--pem-fenced-div-current-indent\)\s*\+\s*var\(--pem-fenced-div-content-indent\)\)\s*!important/s);
