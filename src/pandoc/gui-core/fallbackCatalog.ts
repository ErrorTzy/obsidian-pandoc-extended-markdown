...
export const FALLBACK_OPTIONS: OptionSpec[] = [
    ...
    spec('-s', ['--standalone'], 'standalone', 'Produce a standalone document.', 'boolean', undefined, 'standalone'),
    ...
    spec('--toc', ['--table-of-contents'], 'toc', 'Include a table of contents.', 'boolean'),
    spec('--toc-depth', [], 'toc-depth', 'Number of section levels in the table of contents.', 'integer', 'NUMBER'),
    spec('-N', ['--number-sections'], 'number-sections', 'Number section headings.', 'boolean'),
    ...
    spec('--highlight-style', [], 'highlight-style', 'Syntax highlighting style or file.', 'enum', 'STYLE'),
    spec('--syntax-highlighting', [], 'syntax-highlighting', 'Syntax highlighting mode.', 'enum', 'STYLE'),
    ...
    spec('--embed-resources', [], 'embed-resources', 'Embed linked resources in supported output.', 'boolean'),
...
function spec(
    ...
    return { key, aliases, name, description, valueKind, valuePlaceholder, mapsTo, repeatable };
}
